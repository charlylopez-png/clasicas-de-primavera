...
git add -A
git commit -m "Anade web oficial, fecha y resultados 2026 a cada carrera

- Cada /calendario/[numero] enlaza a la web oficial de la carrera y
  muestra la fecha real de la edicion 2027
- Nueva seccion 'Edicion 2026' con el ganador y el top 20 de la ultima
  edicion disputada, para tener referencia antes de fichar
- El listado /calendario tambien muestra la fecha en cada pastilla
- Corrige el titulo del calendario a 2027 (la temporada real de la porra)
